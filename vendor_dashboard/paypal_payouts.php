...
->setEmailSubject("You Have Paypal Payout Payment From softmatic.in");
...
alert('Congrats, Your Money $$amount Has Been Sent To Your Paypal Account Successfully.');

window.open('index.php?payments','_self');
...
alert('Your Enter Amount Is To Higher Then Your Current Balance.');
...
alert('Your Enter Amount Is Less Then Our Minimum Withdrawal Amount $$minimum_withdraw_limit.');
