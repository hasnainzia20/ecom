...
<p><!-- p Starts -->
<strong>Mall 9</strong>
<br>Abbottabad
<br>KPK
<br>+92 348 9883726
<br>www.mall9.com
<br>
<strong>Hasnain Zia</strong>
...
onsubmit="window.open('https://feedburner.google.com/fb/a/mailverify?uri=softmatic', 'popupwindow', 'scrollbars=yes,width=550,height=520');return true"><!-- form Starts -->

<div class="input-group"><!-- input-group Starts -->

<input type="text" class="form-control" name="email">

<input type="hidden" value="softmatic" name="uri"/>
...
<p class="pull-left"> &copy; Mall 9 </p>

</div><!-- col-md-6 Ends -->

<div class="col-md-6"><!-- col-md-6 Starts -->

<p class="pull-right"> Template by <a href="http://www.mall9.com" >Mall 9</a> </p>
