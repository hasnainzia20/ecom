...
<strong>If you have another account</strong> and you have already used it to purchase the product, you can sign into that account to write a review.
...
<a href="<?php echo $return_url; ?>" class="btn btn-success pull-left" style="border-radius:0px;">Cancel</a>

<input type="submit" name="submit_review" value="Submit Review" class="btn btn-success pull-right" style="border-radius:0px;">
